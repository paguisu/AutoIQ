...
async function cotizarFila({
  ...
  const codia = pick([fila?.infoautocod, fila?.codigo_infoauto, fila?.cod_infoauto, fila?.codigoInfoauto, fila?.CodigoInfoauto, fila?.tau_codia]);
...
const resp = await cotizarFila({
  ...
  fila: fila_final,
        ...
        resultados.push({
          index: i,
          fila_preview: {
            infoautocod: pick([fila_preparada.infoautocod, fila.infoautocod, fila.codigo_infoauto, fila.cod_infoauto, fila.tau_codia]),
